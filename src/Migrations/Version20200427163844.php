 ...
 */
final class Version20200427163844 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE historique_achat (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, produit_id INT DEFAULT NULL, date_achat DATETIME NOT NULL, quantite INT NOT NULL, date_limite DATE DEFAULT NULL, etat_h VARCHAR(255) DEFAULT NULL, INDEX IDX_68295E25FB88E14F (utilisateur_id), INDEX IDX_68295E25F347EFB (produit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prix DOUBLE PRECISION NOT NULL, date_limite DATETIME NOT NULL, taux_sucre VARCHAR(255) NOT NULL, taux_sel VARCHAR(255) NOT NULL, taux_proteine VARCHAR(255) NOT NULL, taux_fibre VARCHAR(255) NOT NULL, taux_energie VARCHAR(255) NOT NULL, taux_gras VARCHAR(255) NOT NULL, nutriscore VARCHAR(255) NOT NULL, taux_additif VARCHAR(255) NOT NULL, marque VARCHAR(255) DEFAULT NULL, taux_calcium VARCHAR(255) DEFAULT NULL, taux_sodium VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
