 ...
 */
final class Version20200419154357 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE historique_achat ADD date_limite DATE DEFAULT NULL, CHANGE date_achat date_achat DATETIME NOT NULL, CHANGE quantite quantite INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE historique_achat DROP date_limite, CHANGE date_achat date_achat DATETIME DEFAULT NULL, CHANGE quantite quantite INT DEFAULT NULL');
