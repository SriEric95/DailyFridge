...
<ul class=\"list-group\">
  <li class=\"list-group-item d-flex justify-content-between align-items-center\">
  <a href=\"{{ path('daily_fridge_Info_Recette') }}\">  Fondue de camembert </a>
    <span class=\"badge badge-primary badge-pill\"></span>
  </li>
  <li class=\"list-group-item d-flex justify-content-between align-items-center\">
    Gulab Jamun
...
{% endblock %}", "daily_fridge/mes_recettes.html.twig", "D:\\INGETIS 2019-2020\\Projet Fil Rouge\\DailyFridge\\templates\\daily_fridge\\mes_recettes.html.twig");
    }
}
