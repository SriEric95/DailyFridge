...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('u-U0fJ8MT4', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BqgpjpMcLF', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService()), [0 => 'D:\\DailyFridge\\src\\Entity']), 'App\\Entity');
    ...
    protected function getLiipImagine_Binary_Loader_DefaultService()
    {
        ...
        return $this->services['liip_imagine.binary.loader.default'] = new \Liip\ImagineBundle\Binary\Loader\FileSystemLoader($a, $a, new \Liip\ImagineBundle\Binary\Locator\FileSystemLocator([0 => 'D:\\DailyFridge/public'], false));
    }
    ...
    {
        return $this->services['liip_imagine.cache.resolver.default'] = new \Liip\ImagineBundle\Imagine\Cache\Resolver\WebPathResolver(($this->services['filesystem'] ?? ($this->services['filesystem'] = new \Symfony\Component\Filesystem\Filesystem())), ($this->privates['router.request_context'] ?? $this->getRouter_RequestContextService()), 'D:\\DailyFridge/public', 'media/cache');
    }
    ...
    protected function getLiipImagine_Filter_ManagerService()
    {
        ...
        $instance->addLoader('paste_image', new \Liip\ImagineBundle\Imagine\Filter\Loader\PasteFilterLoader($a, 'D:\\DailyFridge'));
        $instance->addLoader('paste', new \Liip\ImagineBundle\Imagine\Filter\Loader\PasteFilterLoader($a, 'D:\\DailyFridge\\src'));
        $instance->addLoader('watermark', new \Liip\ImagineBundle\Imagine\Filter\Loader\WatermarkFilterLoader($a, 'D:\\DailyFridge\\src'));
        $instance->addLoader('watermark_image', new \Liip\ImagineBundle\Imagine\Filter\Loader\WatermarkFilterLoader($a, 'D:\\DailyFridge'));
    ...
    protected function getRouting_LoaderService()
    {
        ...
        $b = new \Symfony\Component\HttpKernel\Config\FileLocator(($this->services['kernel'] ?? $this->get('kernel', 1)), 'D:\\DailyFridge\\src/Resources', [0 => 'D:\\DailyFridge\\src'], false);
    ...
    {
        $a = new \Symfony\Bundle\TwigBundle\Loader\NativeFilesystemLoader([], 'D:\\DailyFridge');
        $a->addPath('D:\\DailyFridge\\vendor\\symfony\\framework-bundle/Resources/views', 'Framework');
        $a->addPath('D:\\DailyFridge\\vendor\\symfony\\framework-bundle/Resources/views', '!Framework');
        $a->addPath('D:\\DailyFridge\\vendor\\symfony\\twig-bundle/Resources/views', 'Twig');
        $a->addPath('D:\\DailyFridge\\vendor\\symfony\\twig-bundle/Resources/views', '!Twig');
        $a->addPath('D:\\DailyFridge\\vendor\\doctrine\\doctrine-bundle/Resources/views', 'Doctrine');
        $a->addPath('D:\\DailyFridge\\vendor\\doctrine\\doctrine-bundle/Resources/views', '!Doctrine');
        $a->addPath('D:\\DailyFridge\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $a->addPath('D:\\DailyFridge\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $a->addPath('D:\\DailyFridge\\vendor\\symfony\\web-profiler-bundle/Resources/views', 'WebProfiler');
        $a->addPath('D:\\DailyFridge\\vendor\\symfony\\web-profiler-bundle/Resources/views', '!WebProfiler');
        $a->addPath('D:\\DailyFridge\\vendor\\symfony\\debug-bundle/Resources/views', 'Debug');
        $a->addPath('D:\\DailyFridge\\vendor\\symfony\\debug-bundle/Resources/views', '!Debug');
        $a->addPath('D:\\DailyFridge\\vendor\\liip\\imagine-bundle/Resources/views', 'LiipImagine');
        $a->addPath('D:\\DailyFridge\\vendor\\liip\\imagine-bundle/Resources/views', '!LiipImagine');
        $a->addPath('D:\\DailyFridge/templates');
        $a->addPath('D:\\DailyFridge\\vendor\\symfony\\twig-bridge/Resources/views/Email', 'email');
        $a->addPath('D:\\DailyFridge\\vendor\\symfony\\twig-bridge/Resources/views/Email', '!email');
        $a->addPath('D:\\DailyFridge\\vendor\\symfony\\twig-bridge/Resources/views/Form');
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension($c, 'D:\\DailyFridge', 'UTF-8'));
    ...
    {
        return $this->services['web_profiler.controller.profiler'] = new \Symfony\Bundle\WebProfilerBundle\Controller\ProfilerController(($this->services['router'] ?? $this->getRouterService()), ($this->services['profiler'] ?? $this->getProfilerService()), ($this->services['twig'] ?? $this->getTwigService()), $this->parameters['data_collector.templates'], ($this->privates['web_profiler.csp.handler'] ?? $this->getWebProfiler_Csp_HandlerService()), 'D:\\DailyFridge');
    }
    ...
    /**
     * Gets the private '.service_locator.L5dSlaX' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_L5dSlaXService()
    {
        return $this->privates['.service_locator.L5dSlaX'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    {
        return $this->privates['assets.packages'] = new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('', new \Symfony\Component\Asset\VersionStrategy\JsonManifestVersionStrategy('D:\\DailyFridge/public/build/manifest.json'), new \Symfony\Component\Asset\Context\RequestStackContext(($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), '', false)), []);
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xpn2RdNPXc', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Rl1EhOC3Sk', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tkgMcQ3r1k', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ElYCJudx5Z', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VUBnd+anlR', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WdGnPP1X1P', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $this->privates['console.command.assets_install'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\AssetsInstallCommand(($this->services['filesystem'] ?? ($this->services['filesystem'] = new \Symfony\Component\Filesystem\Filesystem())), 'D:\\DailyFridge');
    ...
    {
        $this->privates['console.command.secrets_decrypt_to_local'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsDecryptToLocalCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('D:\\DailyFridge/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault('D:\\DailyFridge/.env.dev.local'))));
    ...
    {
        $this->privates['console.command.secrets_encrypt_from_local'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsEncryptFromLocalCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('D:\\DailyFridge/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault('D:\\DailyFridge/.env.dev.local'))));
    ...
    {
        $this->privates['console.command.secrets_generate_key'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsGenerateKeysCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('D:\\DailyFridge/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault('D:\\DailyFridge/.env.dev.local'))));
    ...
    {
        $this->privates['console.command.secrets_list'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsListCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('D:\\DailyFridge/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault('D:\\DailyFridge/.env.dev.local'))));
    ...
    {
        $this->privates['console.command.secrets_remove'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsRemoveCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('D:\\DailyFridge/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault('D:\\DailyFridge/.env.dev.local'))));
    ...
    {
        $this->privates['console.command.secrets_set'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsSetCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('D:\\DailyFridge/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault('D:\\DailyFridge/.env.dev.local'))));
    ...
    {
        $this->privates['console.command.translation_debug'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\TranslationDebugCommand(($this->services['translator'] ?? $this->getTranslatorService()), ($this->privates['translation.reader'] ?? $this->getTranslation_ReaderService()), ($this->privates['translation.extractor'] ?? $this->getTranslation_ExtractorService()), 'D:\\DailyFridge/translations', 'D:\\DailyFridge/templates', [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations'], [0 => 'D:\\DailyFridge\\vendor\\symfony\\twig-bridge/Resources/views/Email', 1 => 'D:\\DailyFridge\\vendor\\symfony\\twig-bridge/Resources/views/Form', 2 => 'D:\\DailyFridge\\vendor\\symfony\\framework-bundle\\Command\\TranslationDebugCommand.php', 3 => 'D:\\DailyFridge\\vendor\\symfony\\form\\Extension\\Core\\Type\\FileType.php', 4 => 'D:\\DailyFridge\\vendor\\symfony\\form\\Extension\\Core\\Type\\TransformationFailureExtension.php', 5 => 'D:\\DailyFridge\\vendor\\symfony\\form\\Extension\\Validator\\Type\\UploadValidatorExtension.php', 6 => 'D:\\DailyFridge\\vendor\\symfony\\form\\Extension\\Csrf\\Type\\FormTypeCsrfExtension.php', 7 => 'D:\\DailyFridge\\vendor\\symfony\\validator\\Util\\LegacyTranslatorProxy.php', 8 => 'D:\\DailyFridge\\vendor\\symfony\\framework-bundle\\CacheWarmer\\TranslationsCacheWarmer.php', 9 => 'D:\\DailyFridge\\vendor\\symfony\\translation\\DataCollector\\TranslationDataCollector.php', 10 => 'D:\\DailyFridge\\vendor\\symfony\\twig-bridge\\Extension\\TranslationExtension.php']);
    ...
    protected function getConsole_Command_TranslationUpdateService()
    {
        ...
        $this->privates['console.command.translation_update'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\TranslationUpdateCommand($a, ($this->privates['translation.reader'] ?? $this->getTranslation_ReaderService()), ($this->privates['translation.extractor'] ?? $this->getTranslation_ExtractorService()), 'en', 'D:\\DailyFridge/translations', 'D:\\DailyFridge/templates', [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations'], [0 => 'D:\\DailyFridge\\vendor\\symfony\\twig-bridge/Resources/views/Email', 1 => 'D:\\DailyFridge\\vendor\\symfony\\twig-bridge/Resources/views/Form', 2 => 'D:\\DailyFridge\\vendor\\symfony\\framework-bundle\\Command\\TranslationDebugCommand.php', 3 => 'D:\\DailyFridge\\vendor\\symfony\\form\\Extension\\Core\\Type\\FileType.php', 4 => 'D:\\DailyFridge\\vendor\\symfony\\form\\Extension\\Core\\Type\\TransformationFailureExtension.php', 5 => 'D:\\DailyFridge\\vendor\\symfony\\form\\Extension\\Validator\\Type\\UploadValidatorExtension.php', 6 => 'D:\\DailyFridge\\vendor\\symfony\\form\\Extension\\Csrf\\Type\\FormTypeCsrfExtension.php', 7 => 'D:\\DailyFridge\\vendor\\symfony\\validator\\Util\\LegacyTranslatorProxy.php', 8 => 'D:\\DailyFridge\\vendor\\symfony\\framework-bundle\\CacheWarmer\\TranslationsCacheWarmer.php', 9 => 'D:\\DailyFridge\\vendor\\symfony\\translation\\DataCollector\\TranslationDataCollector.php', 10 => 'D:\\DailyFridge\\vendor\\symfony\\twig-bridge\\Extension\\TranslationExtension.php']);
    ...
    protected function getContainer_EnvVarProcessorService()
    {
        return $this->privates['container.env_var_processor'] = new \Symfony\Component\DependencyInjection\EnvVarProcessor($this, new RewindableGenerator(function () {
            yield 0 => ($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('D:\\DailyFridge/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET'))));
        }, 1));
    }
    ...
    {
        return $this->privates['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL, ($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), 'D:\\DailyFridge', function () {
    ...
    protected function getMaker_AutoCommand_MakeEntityService()
    {
        ...
        $this->privates['maker.auto_command.make_entity'] = $instance = new \Symfony\Bundle\MakerBundle\Command\MakerCommand(new \Symfony\Bundle\MakerBundle\Maker\MakeEntity($a, ($this->privates['maker.doctrine_helper'] ?? $this->getMaker_DoctrineHelperService()), 'D:\\DailyFridge', $b), $a, $b);
    ...
    {
        $this->privates['maker.auto_command.make_migration'] = $instance = new \Symfony\Bundle\MakerBundle\Command\MakerCommand(new \Symfony\Bundle\MakerBundle\Maker\MakeMigration('D:\\DailyFridge'), ($this->privates['maker.file_manager'] ?? $this->getMaker_FileManagerService()), ($this->privates['maker.generator'] ?? $this->getMaker_GeneratorService()));
    ...
    {
        return $this->privates['maker.file_manager'] = new \Symfony\Bundle\MakerBundle\FileManager(($this->services['filesystem'] ?? ($this->services['filesystem'] = new \Symfony\Component\Filesystem\Filesystem())), new \Symfony\Bundle\MakerBundle\Util\AutoloaderUtil(new \Symfony\Bundle\MakerBundle\Util\ComposerAutoloaderFinder('App')), 'D:\\DailyFridge', 'D:\\DailyFridge/templates');
    }
    ...
    {
        return $this->privates['security.user.provider.concrete.in_database'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(($this->services['doctrine'] ?? $this->getDoctrineService()), 'App\\Entity\\Utilisteur', NULL, NULL);
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        ]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\IdentityTranslator()), 'en', ['translation.loader.php' => [0 => 'php'], 'translation.loader.yml' => [0 => 'yaml', 1 => 'yml'], 'translation.loader.xliff' => [0 => 'xlf', 1 => 'xliff'], 'translation.loader.po' => [0 => 'po'], 'translation.loader.mo' => [0 => 'mo'], 'translation.loader.qt' => [0 => 'ts'], 'translation.loader.csv' => [0 => 'csv'], 'translation.loader.res' => [0 => 'res'], 'translation.loader.dat' => [0 => 'dat'], 'translation.loader.ini' => [0 => 'ini'], 'translation.loader.json' => [0 => 'json']], ['cache_dir' => ($this->targetDir.''.'/translations'), 'debug' => true, 'resource_files' => ['af' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.af.xlf'], 'ar' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.ar.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.ar.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.ar.xlf'], 'az' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.az.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.az.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.az.xlf'], 'be' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.be.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.be.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.be.xlf'], 'bg' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.bg.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.bg.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.bg.xlf'], 'ca' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.ca.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.ca.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.ca.xlf'], 'cs' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.cs.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.cs.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.cs.xlf'], 'cy' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.cy.xlf'], 'da' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.da.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.da.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.da.xlf'], 'de' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.de.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.de.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.de.xlf'], 'el' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.el.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.el.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.el.xlf'], 'en' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.en.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.en.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.en.xlf'], 'es' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.es.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.es.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.es.xlf'], 'et' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.et.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.et.xlf'], 'eu' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.eu.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.eu.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.eu.xlf'], 'fa' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.fa.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.fa.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.fa.xlf'], 'fi' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.fi.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.fi.xlf'], 'fr' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.fr.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.fr.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.fr.xlf'], 'gl' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.gl.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.gl.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.gl.xlf'], 'he' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.he.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.he.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.he.xlf'], 'hr' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.hr.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.hr.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.hr.xlf'], 'hu' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.hu.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.hu.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.hu.xlf'], 'hy' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.hy.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.hy.xlf'], 'id' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.id.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.id.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.id.xlf'], 'it' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.it.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.it.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.it.xlf'], 'ja' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.ja.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.ja.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.ja.xlf'], 'lb' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.lb.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.lb.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.lb.xlf'], 'lt' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.lt.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.lt.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.lt.xlf'], 'lv' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.lv.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.lv.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.lv.xlf'], 'mn' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.mn.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.mn.xlf'], 'nb' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.nb.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.nb.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.nb.xlf'], 'nl' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.nl.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.nl.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.nl.xlf'], 'nn' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.nn.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.nn.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.nn.xlf'], 'no' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.no.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.no.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.no.xlf'], 'pl' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.pl.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.pl.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.pl.xlf'], 'pt' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.pt.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.pt.xlf'], 'pt_BR' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.pt_BR.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.pt_BR.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.pt_BR.xlf'], 'ro' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.ro.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.ro.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.ro.xlf'], 'ru' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.ru.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.ru.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.ru.xlf'], 'sk' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.sk.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.sk.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.sk.xlf'], 'sl' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.sl.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.sl.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.sl.xlf'], 'sq' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.sq.xlf'], 'sr_Cyrl' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Cyrl.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.sr_Cyrl.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Cyrl.xlf'], 'sr_Latn' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Latn.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.sr_Latn.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Latn.xlf'], 'sv' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.sv.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.sv.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.sv.xlf'], 'th' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.th.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.th.xlf'], 'tl' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.tl.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.tl.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.tl.xlf'], 'tr' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.tr.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.tr.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.tr.xlf'], 'uk' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.uk.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.uk.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.uk.xlf'], 'vi' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.vi.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.vi.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.vi.xlf'], 'zh_CN' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.zh_CN.xlf', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations\\validators.zh_CN.xlf', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.zh_CN.xlf'], 'zh_TW' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations\\validators.zh_TW.xlf'], 'pt_PT' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations\\security.pt_PT.xlf']], 'scanned_directories' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations', 3 => 'D:\\DailyFridge/translations', 4 => 'D:\\DailyFridge\\vendor\\symfony\\framework-bundle/translations', 5 => 'D:\\DailyFridge\\src/Resources/FrameworkBundle/translations', 6 => 'D:\\DailyFridge\\vendor\\symfony\\twig-bundle/translations', 7 => 'D:\\DailyFridge\\src/Resources/TwigBundle/translations', 8 => 'D:\\DailyFridge\\vendor\\twig\\extra-bundle\\src/translations', 9 => 'D:\\DailyFridge\\src/Resources/TwigExtraBundle/translations', 10 => 'D:\\DailyFridge\\vendor\\sensio\\framework-extra-bundle\\src/translations', 11 => 'D:\\DailyFridge\\src/Resources/SensioFrameworkExtraBundle/translations', 12 => 'D:\\DailyFridge\\vendor\\doctrine\\doctrine-bundle/translations', 13 => 'D:\\DailyFridge\\src/Resources/DoctrineBundle/translations', 14 => 'D:\\DailyFridge\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 15 => 'D:\\DailyFridge\\src/Resources/DoctrineMigrationsBundle/translations', 16 => 'D:\\DailyFridge\\vendor\\symfony\\security-bundle/translations', 17 => 'D:\\DailyFridge\\src/Resources/SecurityBundle/translations', 18 => 'D:\\DailyFridge\\vendor\\symfony\\web-profiler-bundle/translations', 19 => 'D:\\DailyFridge\\src/Resources/WebProfilerBundle/translations', 20 => 'D:\\DailyFridge\\vendor\\symfony\\monolog-bundle/translations', 21 => 'D:\\DailyFridge\\src/Resources/MonologBundle/translations', 22 => 'D:\\DailyFridge\\vendor\\symfony\\debug-bundle/translations', 23 => 'D:\\DailyFridge\\src/Resources/DebugBundle/translations', 24 => 'D:\\DailyFridge\\vendor\\symfony\\maker-bundle\\src/translations', 25 => 'D:\\DailyFridge\\src/Resources/MakerBundle/translations', 26 => 'D:\\DailyFridge\\vendor\\symfony\\web-server-bundle/translations', 27 => 'D:\\DailyFridge\\src/Resources/WebServerBundle/translations', 28 => 'D:\\DailyFridge\\vendor\\liip\\imagine-bundle/translations', 29 => 'D:\\DailyFridge\\src/Resources/LiipImagineBundle/translations', 30 => 'D:\\DailyFridge\\vendor\\symfony\\webpack-encore-bundle\\src/translations', 31 => 'D:\\DailyFridge\\src/Resources/WebpackEncoreBundle/translations', 32 => 'D:\\DailyFridge\\src/Resources/translations'], 'cache_vary' => ['scanned_directories' => [0 => 'D:\\DailyFridge\\vendor\\symfony\\validator/Resources/translations', 1 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/translations', 2 => 'D:\\DailyFridge\\vendor\\symfony\\security-core/Resources/translations', 3 => 'translations', 4 => 'D:\\DailyFridge\\vendor\\symfony\\framework-bundle/translations', 5 => 'D:\\DailyFridge\\src/Resources/FrameworkBundle/translations', 6 => 'D:\\DailyFridge\\vendor\\symfony\\twig-bundle/translations', 7 => 'D:\\DailyFridge\\src/Resources/TwigBundle/translations', 8 => 'D:\\DailyFridge\\vendor\\twig\\extra-bundle\\src/translations', 9 => 'D:\\DailyFridge\\src/Resources/TwigExtraBundle/translations', 10 => 'D:\\DailyFridge\\vendor\\sensio\\framework-extra-bundle\\src/translations', 11 => 'D:\\DailyFridge\\src/Resources/SensioFrameworkExtraBundle/translations', 12 => 'D:\\DailyFridge\\vendor\\doctrine\\doctrine-bundle/translations', 13 => 'D:\\DailyFridge\\src/Resources/DoctrineBundle/translations', 14 => 'D:\\DailyFridge\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 15 => 'D:\\DailyFridge\\src/Resources/DoctrineMigrationsBundle/translations', 16 => 'D:\\DailyFridge\\vendor\\symfony\\security-bundle/translations', 17 => 'D:\\DailyFridge\\src/Resources/SecurityBundle/translations', 18 => 'D:\\DailyFridge\\vendor\\symfony\\web-profiler-bundle/translations', 19 => 'D:\\DailyFridge\\src/Resources/WebProfilerBundle/translations', 20 => 'D:\\DailyFridge\\vendor\\symfony\\monolog-bundle/translations', 21 => 'D:\\DailyFridge\\src/Resources/MonologBundle/translations', 22 => 'D:\\DailyFridge\\vendor\\symfony\\debug-bundle/translations', 23 => 'D:\\DailyFridge\\src/Resources/DebugBundle/translations', 24 => 'D:\\DailyFridge\\vendor\\symfony\\maker-bundle\\src/translations', 25 => 'D:\\DailyFridge\\src/Resources/MakerBundle/translations', 26 => 'D:\\DailyFridge\\vendor\\symfony\\web-server-bundle/translations', 27 => 'D:\\DailyFridge\\src/Resources/WebServerBundle/translations', 28 => 'D:\\DailyFridge\\vendor\\liip\\imagine-bundle/translations', 29 => 'D:\\DailyFridge\\src/Resources/LiipImagineBundle/translations', 30 => 'D:\\DailyFridge\\vendor\\symfony\\webpack-encore-bundle\\src/translations', 31 => 'D:\\DailyFridge\\src/Resources/WebpackEncoreBundle/translations', 32 => 'D:\\DailyFridge\\src/Resources/translations']]]);
    ...
    {
        $this->privates['twig.command.debug'] = $instance = new \Symfony\Bridge\Twig\Command\DebugCommand(($this->services['twig'] ?? $this->getTwigService()), 'D:\\DailyFridge', $this->parameters['kernel.bundles_metadata'], 'D:\\DailyFridge/templates', ($this->privates['debug.file_link_formatter'] ?? $this->getDebug_FileLinkFormatterService()), 'D:\\DailyFridge\\src');
    ...
    protected function getTwig_TemplateCacheWarmerService()
    {
        ...
        ]))->withContext('twig.template_cache_warmer', $this), new \Symfony\Bundle\TwigBundle\TemplateIterator(($this->services['kernel'] ?? $this->get('kernel', 1)), 'D:\\DailyFridge\\src', ['D:\\DailyFridge\\vendor\\symfony\\twig-bridge/Resources/views/Email' => 'email', 'D:\\DailyFridge\\vendor\\symfony\\twig-bridge/Resources/views/Form' => NULL], 'D:\\DailyFridge/templates'));
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings([0 => 'D:\\DailyFridge\\vendor\\symfony\\form/Resources/config/validation.xml']);
    ...
    {
        $this->privates['web_server.command.server_run'] = $instance = new \Symfony\Bundle\WebServerBundle\Command\ServerRunCommand('D:\\DailyFridge/public', 'dev', \dirname(__DIR__, 2));
    ...
    {
        $this->privates['web_server.command.server_start'] = $instance = new \Symfony\Bundle\WebServerBundle\Command\ServerStartCommand('D:\\DailyFridge/public', 'dev', \dirname(__DIR__, 2));
    ...
    {
        return $this->privates['webpack_encore.entrypoint_lookup.cache_warmer'] = new \Symfony\WebpackEncoreBundle\CacheWarmer\EntrypointCacheWarmer(['_default' => 'D:\\DailyFridge/public/build/entrypoints.json'], ($this->targetDir.''.'/webpack_encore.cache.php'), ($this->privates['cache.webpack_encore'] ?? $this->getCache_WebpackEncoreService()));
    }
    ...
    {
        return $this->privates['webpack_encore.entrypoint_lookup[_default]'] = new \Symfony\WebpackEncoreBundle\Asset\EntrypointLookup('D:\\DailyFridge/public/build/entrypoints.json', NULL, '_default', true);
    }
    ...
    {
        return [
            'kernel.root_dir' => 'D:\\DailyFridge\\src',
            'kernel.project_dir' => 'D:\\DailyFridge',
            ...
            'kernel.bundles_metadata' => [
                'FrameworkBundle' => [
                    'path' => 'D:\\DailyFridge\\vendor\\symfony\\framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ],
                'TwigBundle' => [
                    'path' => 'D:\\DailyFridge\\vendor\\symfony\\twig-bundle',
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ],
                'TwigExtraBundle' => [
                    'path' => 'D:\\DailyFridge\\vendor\\twig\\extra-bundle\\src',
                    'namespace' => 'Twig\\Extra\\TwigExtraBundle',
                ],
                'SensioFrameworkExtraBundle' => [
                    'path' => 'D:\\DailyFridge\\vendor\\sensio\\framework-extra-bundle\\src',
                    'namespace' => 'Sensio\\Bundle\\FrameworkExtraBundle',
                ],
                'DoctrineBundle' => [
                    'path' => 'D:\\DailyFridge\\vendor\\doctrine\\doctrine-bundle',
                    'namespace' => 'Doctrine\\Bundle\\DoctrineBundle',
                ],
                'DoctrineMigrationsBundle' => [
                    'path' => 'D:\\DailyFridge\\vendor\\doctrine\\doctrine-migrations-bundle',
                    'namespace' => 'Doctrine\\Bundle\\MigrationsBundle',
                ],
                'SecurityBundle' => [
                    'path' => 'D:\\DailyFridge\\vendor\\symfony\\security-bundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ],
                'WebProfilerBundle' => [
                    'path' => 'D:\\DailyFridge\\vendor\\symfony\\web-profiler-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ],
                'MonologBundle' => [
                    'path' => 'D:\\DailyFridge\\vendor\\symfony\\monolog-bundle',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ],
                'DebugBundle' => [
                    'path' => 'D:\\DailyFridge\\vendor\\symfony\\debug-bundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ],
                'MakerBundle' => [
                    'path' => 'D:\\DailyFridge\\vendor\\symfony\\maker-bundle\\src',
                    'namespace' => 'Symfony\\Bundle\\MakerBundle',
                ],
                'WebServerBundle' => [
                    'path' => 'D:\\DailyFridge\\vendor\\symfony\\web-server-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebServerBundle',
                ],
                'LiipImagineBundle' => [
                    'path' => 'D:\\DailyFridge\\vendor\\liip\\imagine-bundle',
                    'namespace' => 'Liip\\ImagineBundle',
                ],
                'WebpackEncoreBundle' => [
                    'path' => 'D:\\DailyFridge\\vendor\\symfony\\webpack-encore-bundle\\src',
            ...
            'translator.default_path' => 'D:\\DailyFridge/translations',
            ...
            'twig.default_path' => 'D:\\DailyFridge/templates',
            ...
            'doctrine_migrations.dir_name' => 'D:\\DailyFridge/src/Migrations',
