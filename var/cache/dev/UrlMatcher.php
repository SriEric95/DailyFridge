...
return [
    ...
    [ // $regexpList
        0 => '{^(?'
                ...
                .')'
                .'|/test/([^/]++)/([^/]++)(*:192)'
                .'|/daily_fridge_Mon_Frigo_update_(?'
                    .'|consommer/([^/]++)(*:252)'
                    .'|perimer/([^/]++)(*:276)'
                .')'
                .'|/media/cache/resolve/(?'
    ...
    [ // $dynamicRoutes
        ...
        252 => [[['_route' => 'daily_fridge_Mon_Frigo_update_consommer', '_controller' => 'App\\Controller\\DailyFridgeController::updateHisto_consommer'], ['id'], null, null, false, true, null]],
        276 => [[['_route' => 'daily_fridge_Mon_Frigo_update_perimer', '_controller' => 'App\\Controller\\DailyFridgeController::updateHisto_perimer'], ['id'], null, null, false, true, null]],
        339 => [[['_route' => 'liip_imagine_filter_runtime', '_controller' => 'Liip\\ImagineBundle\\Controller\\ImagineController::filterRuntimeAction'], ['filter', 'hash', 'path'], ['GET' => 0], null, false, true, null]],
        365 => [
